...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        //indicatorWrap = a.getBoolean(R.styleable.PagerSlidingTabStrip_pstspstsIndicatorWrapIndicatorWrap, indicatorWrap);
        a.recycle();
    ...
    public void setIndicatorWrap(boolean indicatorWrap) {
