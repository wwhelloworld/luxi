...
public class Frag01_news {
    ...
    public static class TContent{
        ...
        public static class TCate{
            ...
            private	String	url;	/*http://luxi.5kah.com/app/index.php?id=news&pageid=1&psize=10*/
        ...
        public static class TRslist{
            ...
            private	String	cate_url;	/*http://luxi.5kah.com/app/index.php?id=news&cate=xianzhi*/
            private	String	cate_id;	/*685*/
            private	String	attr;	/**/
            private	String	dateline;	/*1526899929*/
            private	String	url;	/*http://luxi.5kah.com/app/index.php?id=2029*/
            private	String	id;	/*2029*/
            private	String	title;	/*这是一条测试数据*/
            private	String	hits;	/*44*/
            private	String	source;	/*123*/
            private	Integer	zan;	/*0*/
            private	Integer	is_zan;	/*0*/
            private	String	writer;	/*123*/
            private	String	thumb;	/*http://luxi.5kah.com/res/img/201805/16/d5a71dae74346c9b.jpg*/
            private	String	note;	/**/
            private	String	video;	/**/
            private	String	cate_name;	/*县直*/
