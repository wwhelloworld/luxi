...
public class HotNotice_Info {
    ...
    public static class TContent {
        ...
        public static class TRslist {
            ...
            private String attr;    /**/
            private String dateline;    /*1526435912*/
            private String url;    /*http://luxi.5kah.com/app/index.php?id=2000*/
            private String marklinker;    /**/
            private String id;    /*2000*/
            private String title;    /*胡春华会见英国和欧盟客人*/
            private String hits;    /*0*/
            private String source;    /*新华社*/
