    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        switch (getItemViewType(i)){
            case TYPE_1:
                ...
                GlideUtils.loadnormoal(context,list.get(i).getThumbnail_pic_s(),holder1.iv1);
                GlideUtils.loadnormoal(context,list.get(i).getThumbnail_pic_s02(),holder1.iv2);
                GlideUtils.loadnormoal(context,list.get(i).getThumbnail_pic_s03(),holder1.iv3);
            ...
            case TYPE_2:
                ...
                GlideUtils.loadnormoal(context,list.get(i).getThumbnail_pic_s(),holder2.iv);
