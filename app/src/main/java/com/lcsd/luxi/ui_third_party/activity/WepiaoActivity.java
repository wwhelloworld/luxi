...
public class WepiaoActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void request_data() {
        ...
        MyApplication.getInstance().getmMyOkHttp().post(this, AppConfig.Wepiao, map, new RawResponseHandler() {
            @Override
