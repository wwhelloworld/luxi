...
import com.lcsd.luxi.ui_third_party.adapter.LsImgAdapter;
...
public class LsContnetActivity extends BaseActivity implements View.OnClickListener {
    ...
    ListView lv;
    @BindView(R.id.history_content_top_view)
    View mView;
    ...
    private void request_data() {
        ...
        map.put("e_id", e_id);
        MyApplication.getInstance().getmMyOkHttp().post(mContext, AppConfig.Lssdjt2, map, new RawResponseHandler() {
            @Override
